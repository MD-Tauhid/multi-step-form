...
export default function ErrorPage() {
    ...
    return (
        ...
        <div class="relative h-screen overflow-hidden bg-indigo-900">
            <img src="https://thelawofattraction.com/wp-content/uploads/Feeling-Alone-And-Sad_-What-To-Do-When-You-Feel-Alone-768x401.png.webp" class="absolute object-cover w-full h-full" />
